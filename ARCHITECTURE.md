...
5. **`AGENTS.md`** — thin redirect for non-Claude-Code agents → `CLAUDE.md` is the canonical
   agent-direction source for this repo (Storybook MCP usage, addon-registration trap, etc.
   live in `CLAUDE.md` § "Storybook MCP").
